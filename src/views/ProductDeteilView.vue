                        ...
                        <div class="flex gap-x-[8px]">
                            ...
                            <div v-for="(c, i) in productDetail.colors" :key="i" class="flex flex-col items-center">
                                <div @click="selectColor(i)" :class="[
                                    ...
                                    i === productIndex ? 'border-1 border-[#6C757D]' : 'border border-transparent',
                                    'cursor-pointer'
                                ]">
                                ...
                                <template v-for="(p, j) in product">
                                    <template v-if="i === productIndex">
                                        <div :class="[
                                            ...
                                            (sizeIndex[0] === i && sizeIndex[1] === j) ? 'border border-[#212529]' : 'border-[#DEE2E6]',
                                            p.in_stock ? 'text-[#212529] cursor-pointer' : 'text-[#DEE2E6] cursor-not-allowed'
