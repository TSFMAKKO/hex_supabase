        ...
        <div class="flex flex-col gap-y-[32px]">
          ...
          <div class="flex flex-col gap-y-[8px]">
            ...
            <div class="grid grid-cols-3 max-md:grid-cols-2 gap-[8px]">
              <div class="py-[12px] px-[24px] text-center border border-[#212529]">
                35(22.5cm)
              </div>
              <div class="py-[12px] px-[24px] text-center border border-[#DEE2E6]">
                35(22.5cm)
              </div>
              <div class="py-[12px] px-[24px] text-center border border-[#DEE2E6]">
                35(22.5cm)
              ...
              <div
                class="py-[12px] px-[24px] text-center border border-[#DEE2E6] text-[#DEE2E6]"
              >
                35(22.5cm)
              </div>
            </div>
...
const productDetail = ref({
  ...
  products: [
    ...
    [
        { size: "35(22.5)", in_stock: true, stock: 2 },
