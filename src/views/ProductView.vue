...
<template>
  ...
  ">
    <div
      class="flex text-[24px] max-sm:text-[20px] font-[700] font-noto leading-[120%] tracking-[1.2px] max-sm:tracking-[1px]
      ">
      加入會員取得 9 折優惠</div>
    <div class="">
  ...
  <div class="flex w-full px-5 ">
    <div
      class="flex max-sm:items-start max-sm:flex-col h-[48px] items-center justify-between w-[1296px]
       m-0 mx-auto  max-sm:mb-[132px] mb-[24px]">
      <div class="text-[28px] font-[700] leading-[120%] tracking-[1.4px] py-[8px] max-sm:mb-[8px]">
        <img src="../assets/logo.svg" alt="" srcset="">
      </div>
      <div
        class="flex max-sm:flex-col gap-x-[40px] max-sm:gap-y-[4px] text-[16px] 
